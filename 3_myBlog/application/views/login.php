...
<div class="MainForm" id="login_page">	
  <form id="frm_login" action="" method="POST" style="float:left; width:620px;" onsubmit="return false">
    ...
    <table>
    	...
    	<tr>
    		<th>登录密码：</th>
    		<td>
                <input name="pwd" id="f_pwd" class="TEXT" style="width: 200px;" type="password">
