	...
	<table cellpadding="0" cellspacing="0">
    	<tbody><tr id="tr_email">
    		...
    		<td>
				...
				<span id="email_msg" class="nodisp"></span>
			</td>
    	</tr>
    	<tr>
    		<th>姓名：</th>
    	...
    	<tr id="tr_gender">
    		...
    		<td>
				...
				<span class="nodisp" id="sex_msg"></span>
			</td>
        </tr>
    	<tr id="tr_area">
    		<th>居住地区：</th>
...
<script>
    ...
    $('.SUBMIT').on('click',function () {
        ...
        if(flag){
            ...
            let code = $('#f_vcode').val();
            $.get('welcome/save_user_massage',{
                email:email,
                name:name,
                pwd:pwd,
                sex:sex,
