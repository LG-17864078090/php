...
<div class="Blog">
  ...
  <div class="BlogTitle">
    ...
    <div class="BlogStat">
		...
		共<strong><a href="#comments"><?php echo $blog->commentnum;?></a></strong>个评论
		<strong><?php echo $blog->collectnum;?></strong>人收藏此文章
	</div> 
  </div>
  <div class="BlogContent TextContent"><?php echo $blog->blog_content;?></div>
    ...
    <h2><a name="comments" href="#postform" class="opts">发表评论»</a>共有 <?php echo $blog->commentnum;?> 条网友评论</h2>
			<ul id="BlogComments">
