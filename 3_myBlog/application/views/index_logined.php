        ...
        <?php foreach ($blogs as $blog){?>
            <li class='Blog' id='blog_24027'>
                ...
                <div class='TextContent' id='blog_content_24027'>
                    ...
                    <div class='fullcontent'><a href="welcome/blog_detail/<?php echo $blog->blog_id?>">阅读全文...</a></div>
...
<div class="comments SpaceModule">
  <strong>最新网友评论</strong>
      <ul>
		<li>
		<span class="u"><a href="#"><img src="images/portrait.gif" class="SmallPortrait" user="154693" align="absmiddle"></a></span>
		<span class="c">hoho
